...
dict_hyper_params = {0: {'nb_merge': 0, 'l0': 1365}, 1: {'nb_merge': 0, 'l0': 1014}, 2: {'nb_merge': 0, 'l0': 717}}
...
num_epochs = 10
save_model_path = '/home/ecd353/NLP_project/experiments/save/models/amazon/exp'+str(exp_index)+'_best.pth.tar'
save_pred_path = '/home/ecd353/NLP_project/experiments/save/predictions/amazon/exp'+str(exp_index)+'.txt'
...
model = Char_CNN_Small.Char_CNN_Small(hyper_params['l0'], hyper_params['alphabet_size'], 0.5, nb_classes, batch_size)
model.init_weights()
model.cuda()
