...
def dataGenerator(file_name='../data/trainYelp.txt',train_split=0.8, max_length=1014, indexing_choice=0,nb_merge = 50):
...
def dataGeneratorTest(list_subword_without_end,file_name='../data/testYelp.txt', max_length=1014, indexing_choice=0):
    if(indexing_choice==0):
        index = indexing
    if(indexing_choice==1):
        index = bigIndexing
...
if __name__ == '__main__': 
    training_set, validation_set,list_subword_without_end,alphabet_size = dataGenerator(nb_merge=300,file_name='../data/trainYelp.txt')
